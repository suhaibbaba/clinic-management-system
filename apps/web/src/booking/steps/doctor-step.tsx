      ...
      {list.map((doctor) => (
        <li key={doctor.id}>
          ...
          >
            <span
              aria-hidden
              className="pill-text inline-flex items-center size-(--control-h) shrink-0 justify-center rounded-pill bg-primary-100 text-value font-medium text-primary-800"
            >
