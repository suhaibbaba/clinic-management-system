  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={cn(
          "pill-text inline-flex items-center text-micro font-medium tabular-nums",
  ...
  return (
    <span
      ...
      className={cn(
        ...
        "pill-text inline-flex items-center gap-1 whitespace-nowrap rounded-pill bg-ink px-2.5 py-1 text-micro",
