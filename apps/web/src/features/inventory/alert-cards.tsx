            ...
            {items.slice(0, 3).map((item) => (
              <li key={item.id}>
                <button
                  ...
                  className="flex min-h-(--control-h) w-full cursor-pointer items-baseline justify-between gap-2 rounded-control px-1 py-0.5 text-start transition-colors duration-150 hover:bg-row-hover lg:min-h-0"
                >
