...
const PATIENTS: readonly PatientSeed[] = [
  ...
  {
    fileNumber: '00005',
    fullName: 'يوسف نبيل البرغوثي',
    phone: '+970599000005',
    dateOfBirth: '1965-05-30',
    gender: GENDER.MALE,
    address: 'عين مصباح، رام الله',
    allergies: ['اليود'],
  ...
  {
    fileNumber: '00007',
    fullName: 'كريم وليد عودة',
    phone: '+970599000007',
    dateOfBirth: '2010-12-05',
    gender: GENDER.MALE,
    address: 'كفر عقب، القدس',
    allergies: [],
  ...
  {
    fileNumber: '00009',
    fullName: 'مازن رياض الجعبري',
    phone: '+970599000009',
    dateOfBirth: '1973-06-11',
    gender: GENDER.MALE,
    address: 'وادي الهرية، الخليل',
    allergies: [],
    chronicConditions: [],
    currentMedications: [],
    isPregnant: null,
  ...
  {
    fileNumber: '00010',
    fullName: 'نور إياد دراغمة',
    phone: '+970599000010',
    dateOfBirth: '1999-08-23',
    gender: GENDER.FEMALE,
    address: 'بيت جالا، بيت لحم',
    allergies: ['السلفا'],
    chronicConditions: [],
    currentMedications: [],
    isPregnant: false,
   ...
   */
  {
    ...
    gender: GENDER.MALE,
    address: 'حي الماصيون، خلف مدرسة الفرندز الثانوية، عمارة الياسمين، الطابق الرابع، رام الله',
